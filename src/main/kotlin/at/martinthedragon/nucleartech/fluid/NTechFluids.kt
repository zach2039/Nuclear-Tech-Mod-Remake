...
object NTechFluids {
    ...
    val oilHot = registerFluid("hot_oil", FluidAttributes.builder(ntm("fluid/hot_oil_still"), ntm("fluid/hot_oil_flow")).temperature(350 - ABSOLUTE_ZERO).sound(null), ::Source, ::Flowing, ::BucketItem, propertiesModifier = { tickRate(30).levelDecreasePerBlock(5) })
    val oilHeavy = registerFluid("heavy_oil", FluidAttributes.builder(ntm("fluid/heavy_oil_still"), ntm("fluid/heavy_oil_flow")), ::Source, ::Flowing, ::BucketItem, propertiesModifier = { tickRate(20).levelDecreasePerBlock(5) })
    val oilLight = registerFluid("light_oil", FluidAttributes.builder(ntm("fluid/light_oil_still"), ntm("fluid/light_oil_flow")), ::Source, ::Flowing, ::BucketItem, propertiesModifier = { tickRate(20).levelDecreasePerBlock(5) })
    val naphtha = registerFluid("naphtha", FluidAttributes.builder(ntm("fluid/naphtha_still"), ntm("fluid/naphtha_flow")), ::Source, ::Flowing, ::BucketItem, propertiesModifier = { tickRate(20).levelDecreasePerBlock(5) })
    val petroleum = registerFluid("petroleum", FluidAttributes.builder(ntm("fluid/petroleum_still"), ntm("fluid/petroleum_still")).gaseous().density(-100).sound(null), GaseousFluid::Source, GaseousFluid::Flowing, ::BucketItem, propertiesModifier = { tickRate(10) })
